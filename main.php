...
<div id="cari2">
  ...
  <input type="text" id="cari" name="keyword"><button id="pembesar">Cari</button></form>
    ...
    <div id="halaman_navigasi">
      ...
      <a href="pages/profil.php"><button id="tombol_navigasi">Profil</button></a>
  ...
  <div id="kiri2">
    ...
    <a href="main.php"><button id="tombol_navigasi_samping">Timeline</button></a><br /><br />
    <a href="pages/explorer.php"><button id="tombol_navigasi_samping">Explorer</button><br /><br /></a>
    <a href="pages/halaman.php"><button id="tombol_navigasi_samping">Halaman</button><br /></a><br />
  </div>
...
<br />
    ...
    include 'database/postingan.php';
          ...
          $data = $postingan->tampilPostingan();
          $i = 1;
          foreach ($data as $row2) :
          ?>

    <div id="postingan">
      <img id="foto_profil_postingan" src="<?= $row2['profil'] ?>" >
      <?php if($row['nama']==$row2['nama']) :?>
      <a href="proses/postingan/hapus.php?id=<?php echo $row2['id']; ?>"><button id="hapus">X</button></a>
      <?php endif; ?>
