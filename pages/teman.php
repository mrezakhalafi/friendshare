...
<div id="cari2">
 ...
 <?php
$mainuser = $row['username'];
          $data = $teman->tampilTeman(); //Masukin $mainuser
          $i = 1; ?>
         <?php
foreach ($data as $row2) :
  ...
  <div id="hasil_cari">
  <img id="foto_postingan_awal" src="../<?php echo $row2['foto'];?>"?>
  <div id="cari_nama">
  <?php
  echo $row2['nama']; ?><br />
  <div id="search_alamat">
  <?php
  echo $row2['alamatrumah'];
  ?>
</div>
  <a href="profil_teman.php?username=<?=$row2['username']?>&nama=<?=$row['username']?>">
  <button id="visit">Visit</button></a>
</div>
</div>
  <?php
endforeach;
